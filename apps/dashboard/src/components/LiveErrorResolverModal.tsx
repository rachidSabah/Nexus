...
export function LiveErrorResolverModal({ isOpen, onClose, target }: LiveErrorResolverModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-nexus-500/30 bg-neutral-950 p-6 shadow-2xl space-y-5">
        ...
        <div className="space-y-2">
          ...
          <div className="h-44 overflow-y-auto rounded-xl border border-white/10 bg-black/50 p-3 font-mono text-xs space-y-1.5 shadow-inner">
